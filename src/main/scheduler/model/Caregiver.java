...
public class Caregiver {
    ...
    private Caregiver(CaregiverBuilder builder) {
        this.CareName = builder.CareName;
        this.salt = builder.salt;
        this.hash = builder.hash;
    }

    private Caregiver(CaregiverGetter getter) {
        this.CareName = getter.CareName;
    ...
    public void saveToDB() throws SQLException {
        ...
        try {
            ...
            statement.setString(1, this.CareName);
    ...
    public void uploadAvailability(Date d) throws SQLException {
        ...
        String addAvailability = "INSERT INTO Availabilities " +
                                 "VALUES (? , ?, ?)";
        try {
            PreparedStatement statement = con.prepareStatement(addAvailability);
            statement.setDate(1, d);
            statement.setBoolean(2, false);
            statement.setString(3, this.CareName);
            statement.executeUpdate();
        } catch (SQLException e) {
            throw new SQLException();
        } finally {
    ...
    public static class CaregiverBuilder {
        ...
        public CaregiverBuilder(String CareName, byte[] salt, byte[] hash) {
    ...
    public static class CaregiverGetter {
        ...
        public CaregiverGetter(String CareName, String password) {
            this.CareName = CareName;
        ...
        public Caregiver get() throws SQLException {
            ...
            String getCaregiver = "SELECT Salt, Hash FROM Caregivers WHERE CareName = ?";
            try {
